...
public class IngresarPersona extends javax.swing.JInternalFrame {
    ...
    public IngresarPersona( ArrayList<Persona> lista) {
        initComponents();
        this.lista=lista;
    }
    ...
    private void initComponents() {
        ...
        cbGenero.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "<Seleccione>", "Femenino", "Masculino" }));
    ...
    private void btnGrabarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGrabarActionPerformed
        ...
        pd.ingresarPersona(lista, id, apellidos, nombres, genero);
